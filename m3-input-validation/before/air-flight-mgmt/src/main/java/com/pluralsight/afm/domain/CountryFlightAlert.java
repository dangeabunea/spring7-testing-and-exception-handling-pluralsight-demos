...
public class CountryFlightAlert {
     ...
     * An alert is active if the provided time is between start and end dates (inclusive).
     */
    public boolean isActiveAt(LocalDateTime dateTime) {
        ...
        boolean afterStart = !dateTime.isBefore(startDateTime);
        boolean beforeEnd = !dateTime.isAfter(endDateTime);
